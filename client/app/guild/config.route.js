(function() {
    ...
    function getRoutes($stateProvider) {
        $stateProvider
            ...
            .state("guild-list", {
                url: "/guild/list?region&languages&faction&realm_name&realm_region&connected_realms&classes&days&timezone&raids_per_week_active&raids_per_week_min&raids_per_week_max&zones&zones_realms",
